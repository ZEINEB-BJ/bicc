...
CREATE TABLE `carts` (
  ...
  CONSTRAINT `carts_ibfk_3` FOREIGN KEY (`seller_id`) REFERENCES `sellers` (`seller_id`)
...
INSERT INTO `carts` VALUES (4,3,1,5,'bbc1','phone','uploads/flousi(3).png',20.00,1,20.00),(5,3,1,5,'bbc1','phone','uploads/flousi(3).png',20.00,1,20.00),(6,3,1,5,'bbc1','phone','uploads/flousi(3).png',20.00,1,20.00),(7,3,1,5,'bbc1','phone','uploads/flousi(3).png',20.00,1,20.00);
