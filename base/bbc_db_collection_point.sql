...
LOCK TABLES `collection_point` WRITE;
/*!40000 ALTER TABLE `collection_point` DISABLE KEYS */;
INSERT INTO `collection_point` VALUES (1,'menzeh  1','koba','agile ');
/*!40000 ALTER TABLE `collection_point` ENABLE KEYS */;
UNLOCK TABLES;
